...
#estratégia rebalanceando a carteira trimestralmente
Trimestral2 = bt.Strategy('Trimestral2',
                       [bt.algos.RunQuarterly(),
                        bt.algos.SelectAll(),
                        bt.algos.WeighEqually(),
                        bt.algos.Rebalance()])
...
st4 = bt.Backtest(Mensal2, data)
st5 = bt.Backtest(Trimestral2, data)
st6 = bt.Backtest(Anual2, data)


# Rodar os backtests para as três estratégias
result = bt.run(st1, st2, st3, st4, st5, st6)
